...
\begin{table}[h]
    ...
    \begin{tabular}{lcccc}
        ...
        AAPM 2016                       & 6     & 2     & 2     & 10 \\
        Mayo LDCT-PD (public)           & \todo{$\sim$120} & \todo{$\sim$40}  & \todo{$\sim$40}  & 200 \\
        \midrule
        \textbf{Total}                  & \textbf{\todo{$\sim$736}} & \textbf{\todo{$\sim$246}} & \textbf{\todo{$\sim$246}} & \textbf{1{,}228} \\
        \bottomrule
    \end{tabular}
...
\paragraph{Limited paired-dose patient count.} The combined AAPM (10) + public Mayo (200) paired-dose cohort is 210 patients. While this is enough for credentialed evaluation of the aggregate chest task, fine-grained sub-population credentials (e.g., per-vendor $\times$ per-pathology) are underpowered.
