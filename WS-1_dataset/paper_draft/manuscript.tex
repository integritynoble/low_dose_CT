...
\begin{enumerate}
    ...
    \item \textbf{Cross-vendor generalization on real paired-dose data.} The public Mayo LDCT-PD cohort is approximately half GE and half Siemens across both anatomies, so v0.5 supports leave-one-vendor-out (GE$\leftrightarrow$Siemens) training/evaluation on \emph{real} paired full-dose / low-dose data under one schema --- a cross-vendor analysis no prior single public low-dose CT release enabled.
