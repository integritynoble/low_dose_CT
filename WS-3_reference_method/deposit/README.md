...
# error-layer trust anchor: spot-check error_abs == |recon - full_dose reference|
python package_corpus.py verify-error-maps <corpus_root>            # all records
python package_corpus.py verify-error-maps <corpus_root> --sample 50  # random sample
```
