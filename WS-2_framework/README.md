...
| [`pwm_dose_equivalence/`](pwm_dose_equivalence/) | Pip-installable Python library; the productionised counterpart to the experiments-folder prototype | **v0.2.0 alpha** — 81/81 tests (incl. 10 end-to-end integration tests) at 100 % line coverage on 265 statements; v0.2.0 added BCa + small-$n$ warning + `bound_M` + integration tests; TestPyPI publish pending (D9 + 365); v1.0.0 alongside paper acceptance (D9 + 540) |
